...
sub help {
    ...
    print STDERR "Usage: cucumber.pl [--features=/some/dir] [--steps=/some/dir/] [--feature_file=/some/file.feature] [--tag=some_tag] [--help]\n";
    print STDERR "  --features - Directory containing .feature test files. Default './features'\n";
    print STDERR "  --steps - Directory containing .step files. Default './features/steps'\n";
    print STDERR "  --feature_file - Individual feature file to run (instead of a directory)\n";
    print STDERR "  --tag - Run only tests marked with a given tag\n";
    print STDERR "  --help - This.\n";
    exit(1);
}
